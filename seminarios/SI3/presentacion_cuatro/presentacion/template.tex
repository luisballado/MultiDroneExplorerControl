...
\begin{frame}%{Dinámica y odometría de un VANT}
  \begin{figure}[ht!]
    ...
    \begin{minipage}{0.48\textwidth}
      \centering
      \includegraphics[width=0.5\linewidth,height=3.5cm]{uav_model.jpeg} % DRONES EN CIUDADES CON GPS DENY
    \end{minipage}
    \vspace{-0.2cm} % Espacio vertical entre imágenes
    \begin{minipage}{0.48\textwidth}
...
\centering
      \includegraphics[width=\linewidth]{robot_arquitectura} % BUSQUEDA Y RESCATE
\end{frame}
