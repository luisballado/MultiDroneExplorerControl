...
\begin{frame}{Metodología}
  ...
  %El objetivo principal es efectuar una exploración con múltiples VANTS de forma coordinada y descentralizada buscando reducir el tiempo total de exploración.\\
  %\bigskip
  \begin{enumerate}
...
\centering
      \includegraphics[width=0.8\linewidth]{arquitectura} % BUSQUEDA Y RESCATE
\end{frame}
...
\begin{frame}{Resultados}
  ...
  %\begin{figure}
  %  \centering
  %  \animategraphics[loop,width=10cm,height=7cm]{10}{ros_map_1/ros_map-}{0}{300}
  %\end{figure}
\end{frame}
...
\off[1] \onok[2] \ondelay[3]  \off[6] \\
\hline
\rowcolor{teal!15}{\textbf{E2.A3.} Control de desplazamientos}
\off[2] \onok[2] \ondelay[4] \off[4] \\
\hline
\rowcolor{teal!15}{\textbf{E2.A4.} Desarrollo de algoritmo de exploraci\'{o}n}
\off[3] \onok[2] \ondelay[3] \off[4] \\
\hline
...
\off[4] \onok[4] \off[4] \\
\hline
\textbf{E2.A8.} Revisi\'{o}n de tesis Etapa 2
\off[7] \on[1] \off[4] \\
\hline
...
\rowcolor{teal!15}{\textbf{E1.A2.} Selecci\'{o}n de algoritmos} \onok[2] \off[10] \\
\hline
\rowcolor{teal!15}{\textbf{E1.A3.} Dise\~{n}o de la AS\footnote{arquitectura de software}}
...
\off[2] \onok[2] \ondelay[5] \off[7] \\
\hline
\textbf{E2.A4.} Desarrollo de AE \footnote{algoritmo de exploración}
