...
\begin{frame}{Motivación del proyecto}
  %Hablar de los usos e importancia del trabajo .. de la exploracion .. etc
\end{frame}
...
\section{Hipótesis y/o preguntas de investigación}
\begin{frame}{Hipótesis y/o preguntas de investigación}
  %\textbf{Exploración}\\
  \bigskip % Vertical whitespace
