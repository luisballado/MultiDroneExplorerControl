...
\begin{frame}{}
  ...
  \begin{minipage}{5cm}
    ...
    \hline
    \textbf{E2.A4.} Desarrollo de algoritmo de exploración
...
\begin{frame}{}
  ...
  %\hspace{0.0cm}
    \begin{minipage}{1cm}
    \noindent\begin{tabular}{|p{13\textwidth}*{16}{|p{0.002\textwidth}}|}
    % The top line
    %\diagbox[width=12.5em]{Actividades}{Cuatrimestres}
    \hline
    ...
    \off[10]  \on[2] \off[4] \\
    \hline
    \textbf{A2.} Clusterizar regiones de fronteras
    \off[11]  \on[1] \off[4] \\
    \hline
    \textbf{A3.} Homologación de mapa
    \off[11]  \on[1] \off[4] \\
    \hline
    ...
    \off[11]  \on[1] \off[4] \\
    \hline
    \textbf{A3.} Solución Método Hungaro
    \off[11]  \on[1] \off[4] \\
    \hline
    ...
    \hline
    \textbf{A1.} Ejecuciones entre las soluciones del estado del arte que su implementación se halla realizado en un ambiente en ROS
    \off[10]  \on[2] \off[4] \\
    \hline
    ...
    \hline
    \textbf{A1.} Comparación resultados con estado del arte con los tiempos en los diferentes mecanismos de coordinación
    \off[10]  \on[2] \off[4] \\
    \hline
    ...
    \hline
    \textbf{A1.} Correcciones revisión 1
    \off[10]  \on[2] \off[4] \\
    \hline
    \textbf{A2.} Correcciones revisión 2
    \off[11]  \on[1] \off[4] \\
    \hline
    \textbf{A3.} Correcciones revisión 3
    \off[11]  \on[1] \off[4] \\
    \hline
    \end{tabular}
  \end{minipage}
...
\begin{frame}{}
  ...
  \scalebox{0.63}{
    \begin{minipage}{1cm}
      \begin{table}[h!]
        \begin{tabular}{|m{0.8cm}|m{8cm}|m{13cm}|}
          \hline
          ...
          \textbf{A1} & Manejo estructura del mapa & \multirow{5}{*}{La visualización simultánea de datos de múltiples VANT puede sobrecargar RVIZ.} \\
          \cline{1-2}
          \textbf{A2} & Comprensión del FOV aplicado dentro del simulador & \\
          \cline{1-2}
          \textbf{A3} & Trazabilidad de la trayectoria & \\
          ...
          \textbf{A4} & Manejo de los mensajes en ROS & \\
          \cline{1-2}
          \textbf{A5} & Manejo de los tópicos en ROS & \\
          \hline
          ...
          \hline
          \textbf{A1} & Comprención de la ejecución del algoritmo A* en $\mathbb{R}^{3}$ & \multirow{2}{*}{Colisiones, trayectorias ineficientes o fallos en la misión de exploración}\\
          \cline{1-2}
          \textbf{A2} & Aplicación de planificador local PVA &\\
          \hline
          ...
          \rowcolor{teal!15}\textbf{Actividad} & \textbf{Producto} & \textbf{Incidencia} \\
          \hline
          \textbf{A1} & Manejo de pase de mapas entre agentes & \multirow{3}{*}{ddddxxxx}\\
          \cline{1-2}
          \textbf{A2} & Clusterizar regiones de fronteras & \\
          \cline{1-2}
          \textbf{A3} & Homologación de mapa & \\
          ...
          \rowcolor{teal!15}\textbf{Actividad} & \textbf{Producto} & \textbf{Incidencia} \\
          \hline
          \textbf{A1} & Solución greedy & \multirow{3}{*}{Mejora la interacción con los clientes, aumentando su satisfacción.}\\
          \cline{1-2}
          \textbf{A2} & Solución branch \& bound & \\
          \cline{1-2}
          \textbf{A3} & Solución método hungaro & \\
          ...
          \rowcolor{teal!15}\textbf{Actividad} & \textbf{Producto} & \textbf{Incidencia} \\
          \hline
          \textbf{A1} & Coordinación del funcionamiento de los componentes de la arquitectura de software & Mejora la interacción con \\
          \hline
          \rowcolor{teal!40}\multicolumn{3}{|l|}{\textbf{Experimentación de resultados}}\\\hline
          \rowcolor{teal!15}\textbf{Actividad} & \textbf{Producto} & \textbf{Incidencia} \\
          \hline
          \textbf{A1} & Ejecuciones entre las soluciones del estado del arte que su implementación se halla realizado en un ambiente en ROS & \multirow{2}{*}{Mejorar la interaccion}\\
          \cline{1-2}
          \textbf{A2} & Ejecuciones con números diferentes de VANTS & \\
          \hline
          ...
          \rowcolor{teal!15}\textbf{Actividad} & \textbf{Producto} & \textbf{Incidencia} \\
          \hline
          \textbf{A1} & Comparación resultados con estado del arte con los tiempos en los diferentes mecanismos de coordinación & Mejora la interacción con los clientes, aumentando su satisfacción. \\
          \hline
          \rowcolor{teal!40}\multicolumn{3}{|l|}{\textbf{Documentación etapa 3}}\\\hline
          \rowcolor{teal!15}\textbf{Actividad} & \textbf{Producto} & \textbf{Incidencia} \\
          \hline
          \textbf{A1} & Escribir & \multirow{2}{*}{Mejora la interacción con los clientes, aumentando su satisfacción.} \\
          \cline{1-2}
          \textbf{A2} & Redactar & \\
          \cline{1-2}
          \textbf{A3} & Modificar & \\
          ...
          \rowcolor{teal!15}\textbf{Actividad} & \textbf{Producto} & \textbf{Incidencia} \\
          \hline
          \textbf{A1} & Correcciones revisión 1 & \multirow{3}{*}{Mejora la interacción con los clientes, aumentando su satisfacción.} \\
          \cline{1-2}
          \textbf{A2} & Correcciones revisión 2 & \\
          \cline{1-2}
          \textbf{A3} & Correcciones revisión 3 & \\
